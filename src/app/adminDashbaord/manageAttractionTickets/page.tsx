...
export default function ManageAttractionTicketsPage() {
  ...
  const queryParams = useMemo(
    () => ({
      status: statusFilter,
      attractionId: attractionFilter === "ALL" ? undefined : attractionFilter,
      search: search.trim() || undefined,
      page,
      limit: PAGE_SIZE,
    }),
    [statusFilter, attractionFilter, search, page],
  );
  ...
  useEffect(() => {
    setPage(1);
  }, [search, statusFilter, attractionFilter]);
      ...
      <DashboardPanel>
        ...
        <DashboardFilterBar className={dashboardFilterBarBorderClass}>
          <div className="flex w-full items-center justify-end gap-3">
            <Label
              htmlFor="group-by-attraction-toggle"
