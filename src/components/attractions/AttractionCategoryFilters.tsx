...
import type { AttractionCategoryOption } from "@/features/attraction-categories/api";
import { ALL_ATTRACTIONS_CATEGORY } from "@/features/attractions/utils";
import { CollapsibleChipRow } from "@/components/filters/CollapsibleChipRow";

type AttractionCategoryFiltersProps = {
...
export function AttractionCategoryFilters({
  categories,
  activeCategory,
  onCategoryChange,
  isLoading,
}: AttractionCategoryFiltersProps) {
  const t = useTranslations("attractions");

  const buttons: AttractionCategoryOption[] = [
    { label: t("allCategory"), value: ALL_ATTRACTIONS_CATEGORY },
    ...categories,
  ];
